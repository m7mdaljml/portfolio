...
1. Cubes Solutions Inc - Front-End Developer (September 2024 – Present, Jordan):
   - Builds and maintains scalable web applications using Vue.js and TypeScript.
   - Develops reusable UI components following best practices and design patterns.
   - Translates complex business requirements into responsive, user-friendly interfaces.
   - Collaborates with cross-functional teams to deliver high-quality products.
   - Was honored as "Technical Team Super Star" in 2025.

2. Anar Company - Full Stack Web Developer (August 2023 – March 2024, Jordan):
...
## Leadership & Competitions (Achievements)
1. Technical Team Super Star - 2025 (Cubes Solution Inc.): Honored as the most outstanding technical team member, recognized for technical excellence, leadership, and significant contributions to the team's success.
2. IEEE Computer Society Chairman - Mutah University Student Branch (2021-2022): Led the IEEE CS chapter, organizing technical workshops, hackathons, and coding competitions. Grew membership by 40% and established partnerships with tech companies.
3. Core Team Member - Google Developer Student Club (2021-2022): Contributed to organizing developer events, study jams, and solution challenges. Mentored junior developers in web development and best practices.
4. JCPC21 & JCPC22 - Jordan Collegiate Programming Contest (2021-2022): Competed in two consecutive years of Jordan's premier collegiate programming competition, solving complex algorithmic problems under time pressure.
...
## الخبرة العملية (المسيرة المهنية)
1. Cubes Solutions Inc - مطور واجهات أمامية (سبتمبر 2024 – الحاضر، الأردن):
   ...
   - حصل على لقب "نجم الفريق التقني" في 2025.

2. Anar Company - مطور ويب متكامل (أغسطس 2023 – مارس 2024، الأردن):
...
## القيادة والمسابقات (الإنجازات)
1. نجم الفريق التقني - 2025 (Cubes Solution Inc.): تم تكريمه بلقب نجم الفريق التقني كأفضل عضو تقني في الفريق، تقديراً للتميز التقني والقيادة والمساهمات الكبيرة في نجاح الفريق.
2. رئيس جمعية IEEE لعلوم الحاسوب - فرع طلاب جامعة مؤتة (2021-2022): قيادة فصل IEEE CS وتنظيم ورش عمل تقنية وهاكاثونات ومسابقات برمجية. زيادة العضوية بنسبة 40% وإقامة شراكات مع شركات تقنية.
3. عضو الفريق الأساسي - نادي مطوري Google للطلاب (2021-2022): المساهمة في تنظيم فعاليات المطورين ودورات الدراسة وتحديات الحلول. إرشاد المطورين المبتدئين في تطوير الويب وأفضل الممارسات.
4. JCPC21 وJCPC22 - مسابقة البرمجة الجامعية الأردنية (2021-2022): التنافس في عامين متتاليين من المسابقة البرمجية الجامعية الأردنية الرائدة، وحل مشكلات خوارزمية معقدة تحت ضغط الوقت.
